...
function connection ()
{
     switch(navigator.network.connection.type)
     {
      case Connection.UNKNOWN:
         $('#imgConnection').attr('src','CrudApp/img/unknown.png');
         break;
       case Connection.WIFI:
         $('#imgConnection').attr('src','CrudApp/img/wifi.png');
         break;
       case Connection.CELL_2:
         $('#imgConnection').attr('src','CrudApp/img/2g.png');
         break;
       case Connection.CELL_3:
         $('#imgConnection').attr('src','CrudApp/img/3g.png');
         break;
       case Connection.CELL_4:
         $('#imgConnection').attr('src','CrudApp/img/4.png');
         break;
        case Connection.NONE:
         $('#imgConnection').attr('src','CrudApp/img/none.png');
         break;
